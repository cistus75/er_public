...
#집가고싶어커밋용커밋드래곤작아밋용작아밋드래곤커밋드래곤의이빨로만든드래곤소드로만든나드래곤스케일로만든갑옷1500골드거위가아주그냥존나커거위가시발존나많은커위커의파편
# death도 detail에 추가할 것. kda만 있음. 현재 몰?루 때문에 실행 시 오류 발생하므로 이 부분 제외하거나 주석 처리 하고 사용할 것.
